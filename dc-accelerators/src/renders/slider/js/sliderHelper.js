window.loryHelpers = {
    navigationDots: function ($sliderBox, sliderInstance, sliderSettings) {
        ...
        var dots = Array.prototype.slice.call($sliderBox.querySelectorAll('.js_dc_slider_dot'), 0);
    ...
    disableNavButtons: function ($sliderBox, sliderInstance) {
        var $slides = Array.prototype.slice.call($sliderBox.querySelectorAll('.js_dc_slide'), 0);
