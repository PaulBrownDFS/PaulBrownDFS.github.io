...
gulp.task('renders-html', function () {
    return gulp.src(['src/renders/**/*.html', '!src/renders/*/templates/*.html', '!src/renders/**/visualisation.html', '!src/renders/**/visualisation_service.html'])
        .pipe(processhtml())
...
gulp.task('renders-files-copy', function () {
    return gulp.src(['src/renders/**/visualisation.html', 'src/renders/**/visualisation_service.html', 'src/renders/**/templates/*.html'])
        .pipe(rename(function (path) {
