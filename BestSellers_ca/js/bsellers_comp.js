...
templates['bestSellers'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"bsCarousel\" class=\"carousel slide\" data-ride=\"carousel\">\n  <h2 class=\"bs_title\">"
    ...
    + "</h2>\n<!-- Indicators -->\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = ((stack1 = (depth0 != null ? depth0.variables : depth0)) != null ? stack1["0"] : stack1)) != null ? stack1.bottomNav : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
